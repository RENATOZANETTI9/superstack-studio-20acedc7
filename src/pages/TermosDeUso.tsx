    ...
    <div className="min-h-screen gradient-hero text-white">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-white/90 space-y-6">
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">2. Aceitação dos Termos</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">3. Descrição do Serviço</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">4. Cadastro e Conta do Usuário</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">5. Obrigações do Usuário</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">6. Propriedade Intelectual</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">7. Limitação de Responsabilidade</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">8. Modificações dos Termos</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">9. Legislação Aplicável e Foro</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold text-foreground mt-8 mb-3">10. Contato</h2>
