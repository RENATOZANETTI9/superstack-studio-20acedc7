...
import { 
  ...
  RotateCcw, ChevronRight, Shield, Zap, AlertTriangle
} from "lucide-react";
        ...
        <Card className="border-0 shadow-2xl bg-card/95 backdrop-blur-xl">
          <CardContent className="p-6 md:p-8">
            ...
            {step === 1 && (
              ...
              >
                Para começar, precisamos de 3 informações: <strong>sua especialidade</strong>, <strong>seu CNPJ</strong> e <strong>seu e-mail</strong>.
