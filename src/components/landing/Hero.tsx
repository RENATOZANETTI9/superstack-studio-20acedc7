...
const brazilPins = [
  // Norte — capitais
  { id: 'AM',       x: 36,  y: 32,  label: 'Manaus' },
  { id: 'PA',       x: 57,  y: 24,  label: 'Belém' },
  { id: 'RR',       x: 40,  y: 13,  label: 'Boa Vista' },
  { id: 'AP',       x: 63,  y: 11,  label: 'Macapá' },
  { id: 'RO',       x: 38,  y: 46,  label: 'Porto Velho' },
  { id: 'AC',       x: 26,  y: 42,  label: 'Rio Branco' },
  { id: 'TO',       x: 61,  y: 43,  label: 'Palmas' },
  // Norte — cidades
  { id: 'Santarém', x: 53,  y: 21,  label: 'Santarém' },
  { id: 'Marabá',   x: 60,  y: 33,  label: 'Marabá' },
  { id: 'Altamira', x: 50,  y: 27,  label: 'Altamira' },
  { id: 'JiParaná', x: 40,  y: 49,  label: 'Ji-Paraná' },
  { id: 'Sinop',    x: 48,  y: 41,  label: 'Sinop' },
  // Nordeste — capitais
  { id: 'MA',       x: 65,  y: 28,  label: 'São Luís' },
  { id: 'PI',       x: 69,  y: 35,  label: 'Teresina' },
  { id: 'CE',       x: 74,  y: 27,  label: 'Fortaleza' },
  { id: 'RN',       x: 78,  y: 26,  label: 'Natal' },
  { id: 'PB',       x: 78,  y: 32,  label: 'João Pessoa' },
  { id: 'PE',       x: 74,  y: 38,  label: 'Recife' },
  { id: 'AL',       x: 77,  y: 43,  label: 'Maceió' },
  { id: 'SE',       x: 75,  y: 48,  label: 'Aracaju' },
  { id: 'BA',       x: 69,  y: 52,  label: 'Salvador' },
  // Nordeste — cidades
  { id: 'Mossoró',  x: 77,  y: 29,  label: 'Mossoró' },
  { id: 'CampGrd',  x: 76,  y: 34,  label: 'Campina Grande' },
  { id: 'Caruaru',  x: 75,  y: 40,  label: 'Caruaru' },
  { id: 'Petrol',   x: 71,  y: 44,  label: 'Petrolina' },
  { id: 'Juazeiro', x: 73,  y: 33,  label: 'Juazeiro do Norte' },
  { id: 'Imperatr', x: 64,  y: 35,  label: 'Imperatriz' },
  { id: 'FeiraSant',x: 72,  y: 53,  label: 'Feira de Santana' },
  { id: 'VitConq',  x: 70,  y: 58,  label: 'Vitória da Conquista' },
  // Centro-Oeste — capitais
  { id: 'MT',       x: 46,  y: 47,  label: 'Cuiabá' },
  { id: 'GO',       x: 58,  y: 57,  label: 'Goiânia' },
  { id: 'DF',       x: 61,  y: 60,  label: 'Brasília' },
  { id: 'MS',       x: 51,  y: 67,  label: 'Campo Grande' },
  // Centro-Oeste — cidades
  { id: 'Anápolis', x: 59,  y: 58,  label: 'Anápolis' },
  { id: 'RondonMT', x: 49,  y: 54,  label: 'Rondonópolis' },
  { id: 'Dourados', x: 51,  y: 70,  label: 'Dourados' },
  // Sudeste — capitais
  { id: 'MG',       x: 65,  y: 60,  label: 'Belo Horizonte' },
  { id: 'ES',       x: 72,  y: 62,  label: 'Vitória' },
  { id: 'RJ',       x: 68,  y: 68,  label: 'Rio de Janeiro' },
  { id: 'SP',       x: 60,  y: 71,  label: 'São Paulo' },
  // Sudeste — cidades
  { id: 'Uberlândia',x: 62, y: 62,  label: 'Uberlândia' },
  { id: 'JuizFora', x: 67,  y: 65,  label: 'Juiz de Fora' },
  { id: 'Campinas', x: 62,  y: 72,  label: 'Campinas' },
  { id: 'Ribeirão', x: 63,  y: 69,  label: 'Ribeirão Preto' },
  { id: 'SJCampos', x: 65,  y: 71,  label: 'São José dos Campos' },
  { id: 'Sorocaba', x: 59,  y: 73,  label: 'Sorocaba' },
  { id: 'SBC',      x: 61,  y: 73,  label: 'São Bernardo do Campo' },
  { id: 'Niterói',  x: 69,  y: 68,  label: 'Niterói' },
  // Sul — capitais
  { id: 'PR',       x: 56,  y: 77,  label: 'Curitiba' },
  { id: 'SC',       x: 55,  y: 83,  label: 'Florianópolis' },
  { id: 'RS',       x: 52,  y: 89,  label: 'Porto Alegre' },
  // Sul — cidades
  { id: 'Londrina', x: 58,  y: 78,  label: 'Londrina' },
  { id: 'Maringá',  x: 57,  y: 77,  label: 'Maringá' },
  { id: 'Joinville',x: 57,  y: 81,  label: 'Joinville' },
  { id: 'Blumenau', x: 56,  y: 83,  label: 'Blumenau' },
  { id: 'CaxiasSul',x: 53,  y: 87,  label: 'Caxias do Sul' },
  { id: 'SantaMari',x: 50,  y: 90,  label: 'Santa Maria' },
  { id: 'Pelotas',  x: 52,  y: 93,  label: 'Pelotas' },
];
