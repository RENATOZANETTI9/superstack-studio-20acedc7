...
const brazilPins = [
  ...
  // Nordeste
  { id: 'MA',       x: 68,  y: 22,  label: 'São Luís' },
  { id: 'MA2',      x: 62,  y: 28,  label: 'Imperatriz' },
  { id: 'CE',       x: 80,  y: 20,  label: 'Fortaleza' },
  { id: 'CE2',      x: 76,  y: 26,  label: 'Juazeiro do Norte' },
  { id: 'RN',       x: 88,  y: 26,  label: 'Natal' },
  { id: 'PI',       x: 72,  y: 32,  label: 'Teresina' },
  { id: 'PI2',      x: 66,  y: 36,  label: 'Floriano' },
  { id: 'PB',       x: 90,  y: 30,  label: 'João Pessoa' },
  { id: 'PB2',      x: 84,  y: 28,  label: 'Campina Grande' },
  { id: 'PE',       x: 86,  y: 34,  label: 'Recife' },
  { id: 'PE2',      x: 80,  y: 36,  label: 'Caruaru' },
  { id: 'AL',       x: 88,  y: 38,  label: 'Maceió' },
  { id: 'SE',       x: 80,  y: 42,  label: 'Aracaju' },
  // Bahia
  { id: 'BA',       x: 74,  y: 48,  label: 'Salvador' },
  { id: 'BA2',      x: 62,  y: 44,  label: 'Barreiras' },
  { id: 'BA3',      x: 70,  y: 52,  label: 'Feira de Santana' },
  { id: 'BA4',      x: 58,  y: 50,  label: 'Vitória da Conquista' },
  { id: 'BA5',      x: 68,  y: 56,  label: 'Ilhéus' },
  // Centro-Oeste
  ...
  // Sudeste
  { id: 'MG',       x: 66,  y: 58,  label: 'Belo Horizonte' },
  { id: 'ES',       x: 78,  y: 60,  label: 'Vitória' },
